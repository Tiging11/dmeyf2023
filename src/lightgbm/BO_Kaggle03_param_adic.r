...
PARAM$experimento <- "BO_baseline_lag6_param_adic"

PARAM$input$dataset <- "./datasets/baseline_exp_colab_lags_6.csv.gz"
...
PARAM$trainingstrategy$semilla_azar <- 300023 # Aqui poner su  primer  semilla

PARAM$hyperparametertuning$POS_ganancia <- 273000
PARAM$hyperparametertuning$NEG_ganancia <- -7000

# Aqui poner su segunda semilla
PARAM$lgb_semilla <- 300073
#------------------------------------------------------------------------------
