...
PARAM$semillas <- c(300007, 300017, 300023, 300073, 999983)
...
setwd("C:\\Users\\tgian\\DMEyF") # Establezco el Working Directory
# cargo los datos
...
archivo_salida <- "./exp/HT2020/gridsearch_3.txt"
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
    for (vmin_bucket in c( 5, 10, 20, 50, 100, 200, 500)) {
